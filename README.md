...
<head>
    ...
    <style>
        ...
        .love-calculator {
            ...
            font-size: 18px;
            color: #e91e63;
            display: none; /* Show after name entry */
        }
        .footer {
            margin-top: 40px;
            font-style: italic;
    ...
    <script>
        ...
        // Always start with signup/login
        ...
        function showContainer() {
            ...
            document.querySelector('.admin-panel').style.display = 'none';
            // Display sender and receiver names if set
            if (senderName && receiverName) {
                document.getElementById('names-display').innerHTML = `<p>Sender: ${senderName} | Receiver: ${receiverName}</p>`;
            }
        }
        ...
        function handleYes() {
            ...
            if (!senderName || !receiverName) {
                alert('Please enter sender and receiver names.');
                return;
            }
            // Show love calculator after name entry
            const lovePercentage = calculateLove(senderName, receiverName);
            document.querySelector('.love-calculator').innerHTML = `<p>Your Love Compatibility: ${lovePercentage}%</p>`;
            document.querySelector('.love-calculator').style.display = 'block';
        ...
        function calculateLove(sender, receiver) {
            const specialNames = ['ALIF', 'ISHAN', 'SHITAL'];
            const senderUpper = sender.toUpperCase();
            const receiverUpper = receiver.toUpperCase();
            if (specialNames.includes(senderUpper) && specialNames.includes(receiverUpper)) {
                return (Math.random() * (99.99 - 98.9) + 98.9).toFixed(2);
            } else {
            ...
            if (submissions.length === 0) {
                ...
                submissions.forEach((sub, index) => {
                    ...
                    div.innerHTML = `
                        ...
                        <strong>User Phone Number:</strong> ${sub.userPhone}<br>
                        <strong>Sender Name:</strong> ${sub.senderName}<br>
                        <strong>Receiver Name:</strong> ${sub.receiverName}<br>
...
<body>
    ...
    <div class="container">
        ...
        <div class="buttons">
            <p>Enter your name (Sender) and the receiver's name:</p>
    ...
    <div class="admin-panel">
        <h1>Admin Panel</h1>
        <p>View all submitted data from all users:</p>
